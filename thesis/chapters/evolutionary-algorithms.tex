...
\begin{enumerate}
    ...
    \item Every dimension in the solution space may require different scaling so that one dimension can require large mutation steps while another dimension only small ones.
\end{enumerate}
