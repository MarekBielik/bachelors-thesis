...
\begin{figure}[H]
    \centerline{\includegraphics[scale=0.7]{best-match}\label{best-match}}
...
\begin{figure}[H]
    \centerline{\includegraphics[scale=0.7]{asymmetrical-ideal-sine}\label{asymmetrical-ideal-sine}}
...
\begin{figure}[H]
    \centerline{\includegraphics[scale=0.7]{symmetrical-ideal-sine}\label{symmetrical-ideal-sine}}
...
The next task for the evolution was to find the right values for
